...
export default {
  ...
  data() {
    return {
      ...
      textInfo: {
        'jvm.memory.max': { color: 'blue', text: 'JVM 最大内存', unit: 'MB' },
        'jvm.memory.committed': { color: 'blue', text: 'JVM 可用内存', unit: 'MB' },
        'jvm.memory.used': { color: 'blue', text: 'JVM 已用内存', unit: 'MB' },
        'jvm.buffer.memory.used': { color: 'blue', text: 'JVM 缓冲区已用内存', unit: 'MB' },
        'jvm.buffer.count': { color: 'blue', text: '当前缓冲区数量', unit: '个' },
        'jvm.threads.daemon': { color: 'blue', text: 'JVM 守护线程数量', unit: '个' },
        'jvm.threads.live': { color: 'blue', text: 'JVM 当前活跃线程数量', unit: '个' },
        'jvm.threads.peak': { color: 'blue', text: 'JVM 峰值线程数量', unit: '个' },
        'jvm.classes.loaded': { color: 'blue', text: 'JVM 已加载 Class 数量', unit: '个' },
        'jvm.classes.unloaded': { color: 'blue', text: 'JVM 未加载 Class 数量', unit: '个' },
        'jvm.gc.memory.allocated': { color: 'blue', text: 'GC 时, 年轻代分配的内存空间', unit: 'MB' },
        'jvm.gc.memory.promoted': { color: 'blue', text: 'GC 时, 老年代分配的内存空间', unit: 'MB' },
        'jvm.gc.max.data.size': { color: 'blue', text: 'GC 时, 老年代的最大内存空间', unit: 'MB' },
        'jvm.gc.live.data.size': { color: 'blue', text: 'FullGC 时, 老年代的内存空间', unit: 'MB' },
